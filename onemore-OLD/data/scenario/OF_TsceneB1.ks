...
[r] "Rather than that, why don't you try remembering? How lonely you were in that other world. Why don't you empathize with Yuuri's loneliness?" [l][r]
...
"And every day, you had warm meals, every day you had warm baths with plenty of clean water, and soft towels to dry yourself. Didn't you feel sorry for Yuuri?" [l][r]
...
[cm]
[tb_start_text mode=3]
"Chito. I understand what you're saying. It's very painful to tell Yuuri these things. So instead, you just need to take on one responsibility." [l][r]
Re...sponsibility? [l][r]
"Watch over Yuuri's final moments. It's painful to tell Yuuri it's the end. She will likely accept it, but I'm sure she'd be scared. [r]
So, you should be there for Yuuri at her last moment." [l][r]
With a somewhat grave expression, "I" spoke as if counseling me. [l][r]
[r] "Come on, tell Yuuri that you can live together in a better world." [l][r]
[_tb_end_text]
...
[tb_start_text mode=3]
"Yes, for you to get back Yuuri, for Yuuri to get back you, and for me to get back... me." [l][r]
[_tb_end_text]
...
When I noticed, Yuuri was looking at me worriedly. ...Couldn't Yuuri see it? So, was it a dream after all? [l][r]
...
[tb_start_text mode=3]
"...Yeah, I'm fine." [r]
I licked my lips slightly, trying to disguise the lingering moisture from Yuuri. [l][r]
"…Just felt that everything I've been thinking about was overflowing..." [r]
"I see." [l][r]
[r] Yuuri looked at me as if she still had something more to say. [l][r]
...
[tb_start_text mode=3]
"Yuuri. This time, I'll tell you my story." [l][r]
I told Yuuri the story from the time I woke up in the other world. A world where food and drink were never a problem. A world where many people lived peacefully without fearing for their lives. [l][r]
...
[r] Surprisingly, Yuuri listened to the end without interrupting. Her first words after I finished were. [l][r]
[_tb_end_text]
...
[tb_start_text mode=3]
Yuuri hopped down from the vehicle she was sitting on and turned to face me. [l][r]
"As long as I can be with Chii-chan again[r]
, I'll be happy." [l][r]
"...But Yuuri, that means" [l][r]
"Well, it means I have to die, right? But it's okay. For Chii-chan, I'd" [r]
With that, Yuuri picked up her gun. [l][r]
"I can do anything." [l][r]
[_tb_end_text]

[cm]
[tb_start_text mode=3]
Her eyes were straight and unwavering. Yuuri, do you really understand? [l][r]
...
Yuuri asked with the ease of someone inquiring how to service a machine. Her gaze was unchanged from our travels together, and I felt relieved. [l][r]
...
[r]Yuuri accepted it. So I will make sure she isn't scared and watch over her until the end... [l][r]
[r]"...Then, let's use the wire there. The gun is too long, so tie it to the trigger..." [l][r]
Yuuri follows my instructions. [r]
...
"Yeah..." [l][r]
Yuuri pulled the wire to check if the trigger would work. With a click, the trigger indeed worked. [l][r]
"Alright, looks good." [l][r]

[r] With a satisfied smile, Yuuri loaded the bullet. Each action weighed heavily on my heart, creating hesitation. [l][r]
[_tb_end_text]
...
"Hmm?" [l][r]
What's wrong? [r]
Yuuri's face, looking so normal, made me ask the same question again. [l][r]
...
The name "Yuuri Kubo" was written on it. Yes, Yuuri. [l][r]
[_tb_end_text]
...
[glink color="black" storage="B1_01CRCS.ks" size="20" text="SIDE-Yuuri" target="*" x="24" y="450" ​​width="" height="" _clickable_img="" ]
