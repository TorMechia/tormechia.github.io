...
[cm  ]
[tb_start_text mode=3 ]
This leaves Yuuri and Chito's caregiver, an old man who isn't related by blood, as the only people she had significant connections with in that world. The old man was likely a soldier, and Chito seems keen to contact military personnel, but confidentiality in those fields creates a high barrier.[l][r]
...
[cm  ]
[tb_start_text mode=3 ]
"The immediate problem is how to find Yuuri."[l][r]
...
Imagining Yuuri surviving alone without Chito in that world was difficult. A hedonistic, seemingly helpless girl—it was our shared perception of Yuuri.[l][r]
...
"Even though I went through a lot of despair in that world, Yuuri helped me bounce back. She's strong, and she has this strange kindness that sees through to the essence of things."[r]
...
"Yeah. Unless Yuuri comes to this world, we can't reunite her with Chito."[l][r]
...
"I'm not saying that. But if Yuuri is here, she will find Chito, no matter what.[r]
...
I thought Yuuri couldn't live without Chito.[l][r]
...
[cm  ]
[tb_start_text mode=3 ]
Tomorrow, I'll cry one more day for Yuuri and that world.[l][r]
Then, I'll think about what to do next. For when Yuuri and I meet again, so we can all laugh together.[l][r]
[_tb_end_text]
