...
[cm  ]
[tb_start_text mode=3 ]
It's been a few months since we found Yuuri. She still hasn't woken up.[l] Seeing Chito's reaction the first time she saw Yuuri in a coma was heart-wrenching.[l][r]
...
It was shortly after I left Chito and Yuuri alone.[l][r]
...
"...About what?"[l][r]
"I'm staying by Yuuri's side. So that I’m here when she wakes up, I'll be waiting."[l][r]
...
[tb_start_text mode=3 ]
From that moment, Chito spent all her available time with Yuuri.[l][r]
She talked about her day, studied, and sometimes spent nights in the hospital room, taking turns with Yuuri’s parents.[l][r]
[r]I worried she might make herself sick and suggested she take a few days off.[l][r]
But Chito said being away from Yuuri for too long actually made her feel worse, and she felt much better when she was with Yuuri.[l][r]
[_tb_end_text]

[cm  ]
[tb_start_text mode=3 ]
According to Chito, doing things for Yuuri also benefited her, so it wasn't a burden at all.[l][r]
[r]And so, a month passed... then half a year… time continued to flow.[l][r]
Despite Chito’s dedicated visits, Yuuri still showed no signs of waking up.[l][r]
But Chito never despaired and kept visiting Yuuri.[l][r]
[_tb_end_text]

[cm  ]
[bg  time="1500"  method="crossfade"  storage="campb.jpg"  ]
[tb_start_text mode=3 ]
"‘I'll be with Yuuri no matter what.’[r]
...
[tb_start_text mode=3 ]
[r]Right now, Chito and Yuuri have gone a bit away to stargaze in a meadow.[l][r]
...
Setting down my coffee, I thought of Chito's determined gaze and Yuuri’s positive demeanor.[l][r]
[_tb_end_text]

[cm  ]
[tb_start_text mode=3 ]
"...I have a feeling Yuuri will wake up soon."[l][r]
...
Me too. Somehow, I don't foresee a bleak future.[l] Even if Yuuri doesn't wake up, we’ll continue on as usual.[l][r]
...
Until Yuuri wakes up. Until she returns to me, I'll stay by her side.[l][r]
[_tb_end_text]
...
My very existence is proof of Yuuri's existence.[l][r]
[_tb_end_text]
...
I held Yuuri's hand and looked up at the sky. Her hand, though thin, was warm.[l][r]
Yes, Yuuri is alive. She's here.[l][r]
...
[tb_start_text mode=3 ]
I gripped Yuuri's hand a little tighter.[l][r]
[r]Yuuri.[l][r]
